...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-lg border-b border-gray-200">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <button onClick={() => scrollToSection('pricing')} className="text-gray-600 hover:text-primary transition-colors">
              Тарифы
            </button>
            <button onClick={() => scrollToSection('university')} className="text-gray-600 hover:text-primary transition-colors">
              Университет
            </button>
            <button onClick={() => scrollToSection('cases')} className="text-gray-600 hover:text-primary transition-colors">
              Кейсы
            </button>
            <button onClick={() => scrollToSection('faq')} className="text-gray-600 hover:text-primary transition-colors">
              FAQ
            </button>
            <Button onClick={() => scrollToSection('contact')}>Начать</Button>
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6">
              <Button size="lg" className="text-lg px-8 py-6 animate-scale-in" onClick={() => scrollToSection('contact')}>
                Начать бесплатно
                <Icon name="ArrowRight" size={20} className="ml-2" />
              </Button>
              <Button size="lg" variant="outline" className="text-lg px-8 py-6 animate-scale-in" onClick={() => scrollToSection('features')}>
                Узнать больше
              </Button>
            </div>
          </div>
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 animate-slide-up">
            <Card className="border-2 hover:border-primary transition-all hover:shadow-xl">
              <CardHeader>
                ...
                <CardTitle>За 5 минут</CardTitle>
                <CardDescription>Создайте профессиональный сайт с помощью ИИ</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-secondary transition-all hover:shadow-xl">
              <CardHeader>
                ...
                <CardTitle>Рост на 300%</CardTitle>
                <CardDescription>Эффективное продвижение от профессиональных маркетологов</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 hover:border-accent transition-all hover:shadow-xl">
              <CardHeader>
                ...
                <CardTitle>50+ курсов</CardTitle>
                <CardDescription>Обучение и сертификация от экспертов индустрии</CardDescription>
              </CardHeader>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: "Globe",
                title: "Создание сайта с ИИ",
                description: "Опишите свой бизнес — получите готовый сайт за минуты",
                color: "primary"
              },
              {
                icon: "Megaphone",
                title: "Продвижение и реклама",
                description: "Профессиональные маркетологи настроят эффективную рекламу",
                color: "secondary"
              },
              {
                icon: "Package",
                title: "Управление товарами",
                description: "Интеграция с маркетплейсами и автоматизация продаж",
                color: "accent"
              },
              {
                icon: "BookOpen",
                title: "Университет продвижения",
                description: "Обучающие курсы с сертификацией от экспертов",
                color: "primary"
              },
              {
                icon: "BarChart3",
                title: "Аналитика и статистика",
                description: "Полный контроль за показателями вашего бизнеса",
                color: "secondary"
              },
              {
                icon: "CreditCard",
                title: "Финансовый учёт",
                description: "Интеграция с банками и автоматическая бухгалтерия",
                color: "accent"
              }
            ].map((feature, index) => (
              <Card key={index} className="group hover:shadow-2xl transition-all hover:-translate-y-1">
                <CardHeader>
            ...
            {[
              ...
              },
              {
                ...
                features: [
                  "Безлимит сайтов",
                  "API доступ",
                  "Команда агентов 24/7",
                  "Реклама во всех каналах",
                  "White-label решения",
                  "Интеграции с 1С",
              ...
              <Card key={index} className={`relative ${plan.popular ? 'border-4 border-primary shadow-2xl scale-105' : ''}`}>
                {plan.popular && (
      ...
      <section id="university" className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
      ...
      <section id="cases" className="py-20 px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              {
                name: "Анна Иванова",
                business: "Онлайн-магазин косметики",
                result: "+250% продаж за 3 месяца",
                quote: "StartBiz помог мне запустить магазин за выходные. Теперь я зарабатываю больше, чем на основной работе!"
              },
              {
                name: "Дмитрий Петров",
                business: "Консалтинговые услуги",
                result: "50+ клиентов в первый месяц",
                quote: "Университет продвижения дал все необходимые знания. Агенты настроили рекламу — заявки пошли сразу!"
              },
              {
                name: "Елена Сидорова",
                business: "Студия дизайна",
                result: "+180% трафика на сайт",
                quote: "Профессиональный сайт и грамотное SEO вывели меня в топ-3 Яндекса по региону. Спасибо команде!"
              },
              {
                name: "Игорь Смирнов",
                business: "Доставка продуктов",
                result: "Окупился за 2 недели",
                quote: "Интеграция с маркетплейсами и автоматизация сэкономили мне по 4 часа в день. Рекомендую!"
              }
            ...
            {[
              {
                ...
                answer: "С помощью нашего ИИ-помощника вы можете создать профессиональный сайт за 5-10 минут. Просто опишите свой бизнес, выберите дизайн — и сайт готов к публикации!"
              },
              {
                question: "Нужны ли технические знания?",
                answer: "Абсолютно нет! StartBiz создан для предпринимателей без технических навыков. Весь интерфейс интуитивно понятен, а наши агенты всегда готовы помочь."
              },
              {
                question: "Как работает система агентов?",
                answer: "Вы получаете персональную команду экспертов: разработчик для сайта, маркетолог для рекламы, товаровед для работы с маркетплейсами. Общение через удобный чат прямо в платформе."
              },
              {
                question: "Можно ли перенести существующий сайт?",
                answer: "Да, наши агенты помогут перенести ваш существующий сайт на платформу StartBiz. Это займёт 1-2 дня в зависимости от сложности проекта."
              },
              {
                question: "Есть ли интеграция с маркетплейсами?",
                answer: "Да, мы интегрированы с Wildberries, Ozon, Яндекс.Маркет и другими популярными площадками. Управляйте всеми товарами из одного места."
              },
              {
                question: "Что включает университет продвижения?",
                answer: "50+ практических курсов по контекстной рекламе, SMM, SEO, email-маркетингу. После прохождения вы получаете сертификат и можете применить знания сразу на практике."
              },
              {
                question: "Как происходит оплата?",
                answer: "Принимаем карты, ЮKassa, электронные кошельки. Тариф «Старт» бесплатен навсегда. Платные тарифы можно оплачивать помесячно или со скидкой за год."
              },
              {
